...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('translation.Users_list') @endslot
    @endcomponent
                                    ...
                                    <td>
                                        <ul class="list-inline font-size-20 contact-links mb-0">
                                            <li class="list-inline-item px-2">
                                                <a href="{{ route('user.edit', ['user' => $user->id]) }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Editar Usuario"><i class="bx bx-edit text-info"></i></a>
                                            </li>
                                            <li class="list-inline-item px-2">
                                                <div data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Borrar Usuario">
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#col-alma-{{ $user->id }}-del"><i class="bx bx-trash text-danger"></i></a>
                                                </div>
                                            </li>
                                        </ul>
                                        <div class="modal fade" id="col-alma-{{ $user->id }}-del">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                <form action="{{ route('user.destroy', ['user' => $user->id]) }}" method="POST" novalidate>
                                                    @csrf
                                                    @method('delete')
                                                    <div class="modal-header">
                                                        <h4 class="text-col-list">¿Está seguro de eliminarlo?</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div><b>{{ $user->name }} {{ $user->first_name }} {{ $user->last_name }}</b> dejará de tener acceso a freefee.</div>
                                                    </div>
