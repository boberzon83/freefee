                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Get your free aye account now.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="p-2">
                                    <form method="POST" class="form-horizontal" action="{{ route('register') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">By registering you agree to the aye <a href="#"
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <div>
                                ...
                                <p>© <script>
                                    ...
                                    </script> freefee. Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand
                                </p>
                            </div>
                        </div>
